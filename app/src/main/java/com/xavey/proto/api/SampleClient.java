...
import com.xavey.proto.helper.GsonIso8601Datelizer;
...
public class SampleClient {
    ...
    private static ApiInterface sWoodyService;

    //returns the Singleton Instance of our Rest client or Creates an new instance
    public static ApiInterface getWoodyApiClient(Context ctx) {
        if (sWoodyService == null) {
            ...
            sWoodyService = adapter.create(ApiInterface.class);
        }
